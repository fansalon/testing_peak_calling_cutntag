...
I have the feeling that the way nf_core CUT&Run pipeline is developed does not do so. Instead, it considers the alignemnts in the BAM file as they derive from SE and PE data.\
